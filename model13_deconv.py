...
class RSIFF(nn.Module):
    def __init__(self, res_block_num=4, block_num=4, spectral_num=8):
        ...
        # self.RSIFF_block = RSIFF_block()
        self.RSIFF_backbone = nn.ModuleList([RSIFF_block() for i in range(block_num)])
        ...
        self.spatial = SPATIAL_Branch(spectral_num)
    ...
    def forward(self, ms, pan):
        ...
        for block in self.RSIFF_backbone:
